...
public class FilledCartsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, Callback<List<ShopItem>>,AdapterFilledCarts.NotifyFilledCart {
    ...
    NotifyTabsActivity notifyTabsActivity;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(getActivity() instanceof NotifyTabsActivity)
        {
            notifyTabsActivity = (NotifyTabsActivity) getActivity();
        }
    ...
    public void onResponse(Call<List<ShopItem>> call, Response<List<ShopItem>> response) {
        ...
        }else
        {
            ...
            if(notifyPagerAdapter!=null) {
                ...
                if(notifyTabsActivity!=null)
                {
                    notifyTabsActivity.notifySwipeRight();
                }
    ...
    public interface NotifyTabsActivity
    {
