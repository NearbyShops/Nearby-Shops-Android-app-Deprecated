...
public class ViewHolderMarketSmallBackup extends RecyclerView.ViewHolder {
    ...
    public static ViewHolderMarketSmallBackup create(ViewGroup parent, Context context, Fragment subscriber)
    {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_market_type_two,parent,false);

        return new ViewHolderMarketSmallBackup(view,context,subscriber);
    }




    public ViewHolderMarketSmallBackup(@NonNull View itemView, Context context, Fragment subscriber) {
        super(itemView);
