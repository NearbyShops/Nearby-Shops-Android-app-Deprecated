...
public class ViewHolderMarketSmall extends RecyclerView.ViewHolder {
    ...
    public static ViewHolderMarketSmall create(ViewGroup parent, Context context, listItemMarketNotifications subscriber)
    {
    ...
    public ViewHolderMarketSmall(@NonNull View itemView, Context context, listItemMarketNotifications subscriber) {
        super(itemView);
