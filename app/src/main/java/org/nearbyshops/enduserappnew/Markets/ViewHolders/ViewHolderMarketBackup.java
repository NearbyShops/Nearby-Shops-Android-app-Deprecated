...
public class ViewHolderMarketBackup extends RecyclerView.ViewHolder implements View.OnClickListener {
...
//    @BindView(R.id.indicator_verified) TextView indicatorVerified;
    ...
    public static ViewHolderMarketBackup create(ViewGroup parent, Context context, Fragment subscriber)
    {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_market, parent, false);

        return new ViewHolderMarketBackup(view,parent,context,subscriber);
    }
    ...
    public ViewHolderMarketBackup(View itemView, ViewGroup parent, Context context, Fragment subscriber)
    {
        super(itemView);
