...
import org.nearbyshops.enduserappnew.Model.ShopAdmin;

import java.sql.Timestamp;

public class ShopParcellable implements Parcelable {
...
//	public static final String BACKDROP_IMAGE_PATH = "BACKDROP_IMAGE_PATH";
	...
	public static final String createTableShopPostgres =
			"CREATE TABLE IF NOT EXISTS " + ShopParcellable.TABLE_NAME + "("
			+ " " + ShopParcellable.SHOP_ID + " SERIAL PRIMARY KEY,"
			+ " " + ShopParcellable.SHOP_NAME + " text,"

			+ " " + ShopParcellable.DELIVERY_RANGE + " FLOAT,"
			+ " " + ShopParcellable.LON_CENTER + " FLOAT,"
			+ " " + ShopParcellable.LAT_CENTER + " FLOAT,"

			+ " " + ShopParcellable.DELIVERY_CHARGES + " FLOAT,"
			+ " " + ShopParcellable.BILL_AMOUNT_FOR_FREE_DELIVERY + " INT,"
			+ " " + ShopParcellable.PICK_FROM_SHOP_AVAILABLE + " boolean,"
			+ " " + ShopParcellable.HOME_DELIVERY_AVAILABLE + " boolean,"

			+ " " + ShopParcellable.SHOP_ENABLED + " boolean,"
			+ " " + ShopParcellable.SHOP_WAITLISTED + " boolean,"

			+ " " + ShopParcellable.LOGO_IMAGE_PATH + " text,"

			+ " " + ShopParcellable.SHOP_ADDRESS + " text,"
			+ " " + ShopParcellable.CITY + " text,"
			+ " " + ShopParcellable.PINCODE + " INT,"
			+ " " + ShopParcellable.LANDMARK + " text,"

			+ " " + ShopParcellable.CUSTOMER_HELPLINE_NUMBER + " text,"
			+ " " + ShopParcellable.DELIVERY_HELPLINE_NUMBER + " text,"

			+ " " + ShopParcellable.SHORT_DESCRIPTION + " text,"
			+ " " + ShopParcellable.LONG_DESCRIPTION + " text,"

			+ " " + ShopParcellable.DATE_TIME_STARTED + " timestamp with time zone NOT NULL DEFAULT now(),"
			+ " " + ShopParcellable.IS_OPEN + " boolean,"
...
//	private double lonMin;
	...
	protected ShopParcellable(Parcel in) {
		shopID = in.readInt();
	...
	public static final Creator<ShopParcellable> CREATOR = new Creator<ShopParcellable>() {
		@Override
		public ShopParcellable createFromParcel(Parcel in) {
			return new ShopParcellable(in);
		}

		@Override
		public ShopParcellable[] newArray(int size) {
			return new ShopParcellable[size];
		}
	};
