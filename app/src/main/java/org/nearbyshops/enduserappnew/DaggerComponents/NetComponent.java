...
import org.nearbyshops.enduserappnew.Markets.ViewHolders.ViewHolderMarketSmallBackup;
...
public interface NetComponent {
    ...
    void Inject(ViewHolderMarketSmallBackup viewHolderMarketSmallBackup);
}
