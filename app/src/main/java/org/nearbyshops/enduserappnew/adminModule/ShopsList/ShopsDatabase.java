...
public class ShopsDatabase extends AppCompatActivity implements NotifyTitleChanged, NotifySort, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener , LocationListener,
        GetLocation {
