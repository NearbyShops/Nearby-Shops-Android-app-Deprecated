...
public class AdapterItemCatHorizontal extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterItemCatHorizontal(List<ItemCategory> dataset, Context context, Fragment fragment) {
