...
import org.nearbyshops.enduserappnew.ItemsByCategoryTypeOne.ViewHolders.ViewHolderItemSimple;
...
public class AdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        else if(holder instanceof ViewHolderHorizontalList)
        {
            ...
            ((ViewHolderHorizontalList) holder).setItem(new AdapterItemCatHorizontal(list,context,fragment));
