package org.nearbyshops.enduserappnew.ItemsByCategoryTypeTwo.ViewHolders;
...
public class ViewHolderItemCategoryNew extends RecyclerView.ViewHolder{
    ...
    public static ViewHolderItemCategoryNew create(ViewGroup parent, Context context, Fragment fragment,
    ...
    public ViewHolderItemCategoryNew(View itemView, Context context, Fragment fragment, RecyclerView.Adapter adapter
    )
    {
        super(itemView);
