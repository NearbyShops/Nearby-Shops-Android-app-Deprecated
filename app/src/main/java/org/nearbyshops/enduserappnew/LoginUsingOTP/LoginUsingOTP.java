...
import org.nearbyshops.enduserappnew.Login.ShowFragmentSelectService;
import org.nearbyshops.enduserappnew.R;


public class LoginUsingOTP extends AppCompatActivity implements ShowFragmentSelectService, NotifyAboutLogin {
...
//        setSupportActionBar(toolbar);
        ...
        if(savedInstanceState==null)
        {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container,new InsertPhoneFragment(),TAG_STEP_ONE)
                    .commitNow();
        }
