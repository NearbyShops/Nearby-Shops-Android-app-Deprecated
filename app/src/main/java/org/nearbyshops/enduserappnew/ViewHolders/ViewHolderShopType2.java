...
public class ViewHolderShopType2 extends RecyclerView.ViewHolder{
    ...
    public static ViewHolderShopType2 create(ViewGroup parent, Context context, Fragment fragment,
                                             RecyclerView.Adapter adapter)
    {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_shop_new,parent,false);
        return new ViewHolderShopType2(view,context,fragment);
    }
    ...
    public ViewHolderShopType2(@NonNull View itemView, Context context, Fragment fragment) {
        super(itemView);
