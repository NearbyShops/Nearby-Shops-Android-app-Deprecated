...
import org.nearbyshops.enduserapp.ItemCategoryOption.Interfaces.NotifyBackPressed;
import org.nearbyshops.enduserapp.ItemCategoryOption.Interfaces.NotifyCategoryChanged;
...
//    @State int currentCategoryID = 1; // the ID of root category is always supposed to be 1
    @State ItemCategory currentCategory = null;
