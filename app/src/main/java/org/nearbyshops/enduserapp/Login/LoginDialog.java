...
//    {
//
//        String header = PrefLogin.baseEncoding(username.getText().toString(),password.getText().toString());
//
//
...
//                {
//
////                    PrefLogin.saveUserProfile(response.body(),LoginDialog.this.getActivity());
//                    PrefLogin.saveCredentials(getActivity(),username.getText().toString(),password.getText().toString());
//
...
//                    progressBar.setVisibility(View.GONE);
//
////                    User endUser = response.body();
////                    PrefLogin.saveCredentials(getContext(),endUser.getUsername(),endUser.getPassword());
////                    PrefLogin.saveUserProfile(endUser,getActivity());
//
//                    dismiss();
//                }
//                else
