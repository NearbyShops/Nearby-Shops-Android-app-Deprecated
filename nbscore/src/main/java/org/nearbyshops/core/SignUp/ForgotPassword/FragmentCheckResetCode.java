...
//    @BindView(R.id.confirm_password) EditText confirmPassword;
    ...
    @BindView(R2.id.header_title) TextView headerTitle;
...
//
    ...
    @OnTextChanged(R2.id.verification_code)
...
//
    ...
    @BindView(R2.id.resend_code)
    TextView resendCode;


    @OnClick(R2.id.resend_code)
