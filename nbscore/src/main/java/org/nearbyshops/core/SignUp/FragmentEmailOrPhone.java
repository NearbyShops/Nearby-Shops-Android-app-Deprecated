...
import org.nearbyshops.core.DaggerComponentBuilder;
...
import org.nearbyshops.core.SignUp.Interfaces.ShowFragmentSignUp;
...
public class FragmentEmailOrPhone extends Fragment {
    ...
    @BindView(R2.id.select_email) TextView selectPhone;
    @BindView(R2.id.select_phone) TextView selectEmail;

    @BindView(R2.id.text_input_phone)
    TextInputLayout phoneLayout;
    @BindView(R2.id.text_input_email) TextInputLayout emailLayout;
    ...
    @BindView(R2.id.email) TextInputEditText email;
    ...
    @BindView(R2.id.phone_registration_message) TextView phoneRegistrationMessage;
    ...
    @BindView(R2.id.next) TextView nextButton;
    @BindView(R2.id.progress_bar_next) ProgressBar progressBarNext;
...
//            showToastMessage("Phone : " + user.getRt_phone_country_code() + "-" + user.getPhone());
    ...
    @OnTextChanged({R2.id.email, R2.id.phone})
...
//            showToastMessage("Phone : " + inputName);
        ...
        if(PrefGeneral.getMultiMarketMode(getActivity()))
        {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .baseUrl(PrefServiceConfig.getServiceURL_SDS(MyApplicationCoreNew.getAppContext()))
